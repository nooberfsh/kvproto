...
type BatchLockResolveRequest struct {
	Context    *Context     `protobuf:"bytes,1,opt,name=context" json:"context,omitempty"`
	Tx_2Status []*TxnStatus `protobuf:"bytes,2,rep,name=tx_2_status,json=tx2Status" json:"tx_2_status,omitempty"`
}
...
func (m *BatchLockResolveRequest) GetTx_2Status() []*TxnStatus {
	if m != nil {
		return m.Tx_2Status
	}
	return nil
...
func (m *BatchLockResolveRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Tx_2Status) > 0 {
		for _, msg := range m.Tx_2Status {
			dAtA[i] = 0x12
			i++
			i = encodeVarintKvrpcpb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *BatchLockResolveRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Tx_2Status", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Tx_2Status = append(m.Tx_2Status, &TxnStatus{})
			if err := m.Tx_2Status[len(m.Tx_2Status)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
